...
int *z;
 z = &UNIVERSAL;
     ...
     gets(name);
     printf("\t\t\tEnter your D.O.B. in formate dd-mm-yyyy: ");
     gets(birth_date);
  ...
  void show()
  {
   ...
   void winner()
   {
       ...
       if(vote1<vote2 && vote3< vote2 && vote4<vote2 && vote5<vote2)
        ...
        printf("\t\t\tThe present Winner is Rahul Gandhi and she has got %d votes\n\n\n\n",vote3);
        ...
        printf("\t\t\t\tEnter Any Key for Main Log or The voting is not done yet...\n\n");
        getch();
        main_logs(start);
